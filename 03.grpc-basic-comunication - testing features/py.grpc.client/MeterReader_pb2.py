...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x11MeterReader.proto\x1a\nenum.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"e\n\rReadingPacket\x12!\n\x08readings\x18\x01 \x03(\x0b\x32\x0f.ReadingMessage\x12\r\n\x05notes\x18\x02 \x01(\t\x12\"\n\nsuccessful\x18\x03 \x01(\x0e\x32\x0e.ReadingStatus\"w\n\x0eReadingMessage\x12\x12\n\ncustomerId\x18\x01 \x01(\x05\x12\x14\n\x0creadingValue\x18\x02 \x01(\x05\x12/\n\x0breadingTime\x18\x05 \x01(\x0b\x32\x1a.google.protobuf.TimestampJ\x04\x08\x03\x10\x04J\x04\x08\x04\x10\x05\"A\n\rStatusMessage\x12\x0f\n\x07message\x18\x01 \x01(\t\x12\x1f\n\x07success\x18\x02 \x01(\x0e\x32\x0e.ReadingStatus2C\n\x13MeterReadingService\x12,\n\nAddReading\x12\x0e.ReadingPacket\x1a\x0e.StatusMessageB\x16\xaa\x02\x13grpc.server.Serviceb\x06proto3'
  ,
  dependencies=[enum__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,])
...
_READINGPACKET.fields_by_name['successful'].enum_type = enum__pb2._READINGSTATUS
_READINGMESSAGE.fields_by_name['readingTime'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_STATUSMESSAGE.fields_by_name['success'].enum_type = enum__pb2._READINGSTATUS
